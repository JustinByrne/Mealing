...
<x-auth-card>
    ...
    <form class="w-full max-w-sm" method="POST" action="{{ route('login.authenticate') }}" id="loginForm">
        ...
        <div class="md:flex md:items-center mb-6">
            <div class="md:w-1/3">
                <label class="block text-blueGray-500 font-bold md:text-right mb-1 md:mb-0 pr-4" for="email">
                    Email
                </label>
            </div>
            <div class="md:w-2/3">
        ...
        <div class="md:flex md:items-center mb-6">
            <div class="md:w-1/3">
                <label class="block text-blueGray-500 font-bold md:text-right mb-1 md:mb-0 pr-4" for="password">
                    Password
                </label>
            </div>
            <div class="md:w-2/3">
        ...
        <div class="md:flex md:items-center mb-6">
            ...
            <label class="md:w-2/3 block text-blueGray-500 font-bold">
