...
@php
    $classes = ($error ?? false)
                ? 'bg-red-200 appearance-none border-2 border-red-400 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-red-500'
