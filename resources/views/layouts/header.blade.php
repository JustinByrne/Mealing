            ...
            <nav class="flex flex-col space-y-3">
                ...
                @if (request()->routeIs('recipes*'))
                    <div class="w-full" x-data="{open: true}">
                        <div class="w-full p-3 font-bold rounded-lg bg-white text-green-700 space-x-2 cursor-pointer" @click="open = !open">
                @else
                    <div class="w-full" x-data="{open: false}">
                        <div class="w-full p-3 font-bold rounded-lg hover:bg-white hover:text-green-700 space-x-2 cursor-pointer" @click="open = !open">
                @endif
